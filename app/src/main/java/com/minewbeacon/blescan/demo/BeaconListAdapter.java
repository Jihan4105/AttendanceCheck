...
public class BeaconListAdapter extends RecyclerView.Adapter<BeaconListAdapter.MyViewHolder> {
    ...
    static public String beacon_Major;
    static public String beacon_Minor;
...
//        validateItems(newItems);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDataAndUi(MinewBeacon minewBeacon) {
            ...
            beacon_Major = mMinewBeacon.getBeaconValue(BeaconValueIndex.MinewBeaconValueIndex_Major).getStringValue();
            beacon_Minor = mMinewBeacon.getBeaconValue(BeaconValueIndex.MinewBeaconValueIndex_Minor).getStringValue();
